...
torchrun --standalone --nproc_per_node=1 \
    ...
    --model_path out_cvn_memlite/model_final.rank_0.pth \
    --eval_gz_path /nfs/data/1/rrazakami/work/data_cvn/data/dune/2023_trainings/latest/dunevd/prodgenie_dunevd_1x8x6_nu/cvn_gaushit/4874064_1581 \
    --patch_size 4 \
    --image_size 448 448 \
    --model_type vit_tiny \
