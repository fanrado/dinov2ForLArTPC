...
torchrun --standalone --nproc_per_node=1 \
  ...
  --output-dir /nfs/data/1/nitish/dino_output/cvn_properrun2 \
  ...
  train.num_workers=2 \
  crops.global_crops_size=224 crops.local_crops_size=96 crops.local_crops_number=8 student.patch_size=16 \
  ...
  dino.koleo_loss_weight=0.02 optim.base_lr=0.0002 optim.clip_grad=2.0 \
  optim.adamw_beta2=0.99 student.drop_path_rate=0.1 student.arch=vit_base \
