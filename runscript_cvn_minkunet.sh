...
torchrun --standalone --nproc_per_node=1 \
  ...
  --output-dir /nfs/data/1/nitish/dino_output/cvn_minkunet_base \
  ...
  train.num_workers=2 \
  crops.global_crops_size=240 crops.local_crops_size=40 crops.local_crops_number=8 student.patch_factor=4 \
